...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private final RevServo servo = new RevServo(Shooter.SERVO_PWM_ID);
  ...
  public ShooterSubsystem() {
    ...
    leftPIDController.setTolerance(25.0, 5.0);
    rightPIDController.setTolerance(25.0, 5.0);
